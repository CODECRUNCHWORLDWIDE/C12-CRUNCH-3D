...
Next: prove it. Continue to the [exercises](../03-exercises/00-overview.md), then the [mini-project](../07-mini-project/00-overview.md) where you parameterize your assembly's key part into a family and ship its drawing.
