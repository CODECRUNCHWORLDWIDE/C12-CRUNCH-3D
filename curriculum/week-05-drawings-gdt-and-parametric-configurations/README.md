...
| [resources.md](./resources.md) | Curated OnShape Learning Center, ASME/GD&T, and reference links |
| [lecture-notes/01-the-drawing-package.md](./lecture-notes/01-the-drawing-package.md) | Drawing tabs, ortho & section views, dimensioning, title blocks, BOM, and GD&T basics |
| [lecture-notes/02-parametric-power-variables-and-configurations.md](./lecture-notes/02-parametric-power-variables-and-configurations.md) | Variable Studios, equations, configuration inputs, configuration tables, part families |
| [exercises/README.md](./exercises/README.md) | Index of the week's modeling/drawing drills |
| [exercises/exercise-01-first-drawing.md](./exercises/exercise-01-first-drawing.md) | Guided: make your first drawing — views, dimensions, title block |
| [exercises/exercise-02-section-views-and-gdt.md](./exercises/exercise-02-section-views-and-gdt.md) | Section view + datums + flatness + position feature control frames |
| [exercises/exercise-03-configurations-part-family.md](./exercises/exercise-03-configurations-part-family.md) | Variable Studio + Configurations table → one part, three sizes |
| [challenges/README.md](./challenges/README.md) | Index of the weekly challenge |
| [challenges/challenge-01-manufacturing-ready-drawing.md](./challenges/challenge-01-manufacturing-ready-drawing.md) | A manufacturing-ready, toleranced, configured drawing of an earlier part |
| [quiz.md](./quiz.md) | 10 multiple-choice questions |
| [homework.md](./homework.md) | Six practice problems for the week |
| [mini-project/README.md](./mini-project/README.md) | Full spec: parameterize the assembly's key part + ship its drawing |
