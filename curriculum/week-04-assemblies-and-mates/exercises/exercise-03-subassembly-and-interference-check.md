...
You've now built, organized, and *validated* a mechanism. That's the full Week 4 loop. Take it into the [challenge](../challenges/challenge-01-four-bar-linkage.md) (a 1-DOF four-bar linkage) and the [mini-project](../mini-project/README.md) (your running part, now articulating).
