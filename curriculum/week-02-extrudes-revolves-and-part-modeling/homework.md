...
When you've finished all six, **create a Version** of the Document (`Week 2 homework`), confirm every part is green, and share the public link in your cohort tracker. Then open the [mini-project](./mini-project/README.md) if you haven't already — the homework parts are good warm-up for it.
