...
You've now exercised the entire single-body modeling toolkit. Take these reflexes into the [challenge](../04-challenges/challenge-01-shelled-bottle.md) and the [mini-project](../07-mini-project/00-overview.md).
