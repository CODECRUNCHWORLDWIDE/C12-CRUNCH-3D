...
| [resources.md](./resources.md) | Curated OnShape Learning Center, Help, and reference links with annotations |
| [lecture-notes/01-extrude-end-conditions-and-booleans.md](./lecture-notes/01-extrude-end-conditions-and-booleans.md) | From 2D to 3D: Extrude operations, end conditions, the merge scope, and Boolean solids |
| [lecture-notes/02-revolves-holes-and-dress-up-features.md](./lecture-notes/02-revolves-holes-and-dress-up-features.md) | Revolve, the Hole feature, Fillet, Chamfer, Shell, and Draft — making a part manufacturable |
| [exercises/README.md](./exercises/README.md) | Index of the week's modeling drills + a checklist |
| [exercises/exercise-01-extrude-and-pocket-a-bracket.md](./exercises/exercise-01-extrude-and-pocket-a-bracket.md) | Guided: extrude a base, add a boss, cut a pocket, verify dimensions |
| [exercises/exercise-02-revolve-a-knob.md](./exercises/exercise-02-revolve-a-knob.md) | Modeling task: revolve a profile into a knurled-grip control knob |
| [exercises/exercise-03-holes-fillets-shell.md](./exercises/exercise-03-holes-fillets-shell.md) | Modeling task: place counterbored holes, fillet, and shell an enclosure base |
| [challenges/README.md](./challenges/README.md) | What the challenge is and how it's assessed |
| [challenges/challenge-01-shelled-bottle.md](./challenges/challenge-01-shelled-bottle.md) | Reproduce a bottle/cup from a photo: revolve, shell, filleted base |
| [mini-project/README.md](./mini-project/README.md) | Promote Week 1's master sketch into a finished solid part |
| [quiz.md](./quiz.md) | 10 multiple-choice questions with answer key |
| [homework.md](./homework.md) | Six modeling problems with a grading rubric |
