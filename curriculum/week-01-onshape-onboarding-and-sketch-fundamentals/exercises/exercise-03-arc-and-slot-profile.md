...
This profile is the template for the mini-project. When it's solid, open the [mini-project spec](../mini-project/README.md) and build your own running-project master sketch.
