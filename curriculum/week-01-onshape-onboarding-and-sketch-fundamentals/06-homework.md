...
When you've finished all five tasks, push your `NOTES.md` and screenshots, then start the [mini-project](./07-mini-project/00-overview.md) — the master sketch you carry through the rest of C12.
