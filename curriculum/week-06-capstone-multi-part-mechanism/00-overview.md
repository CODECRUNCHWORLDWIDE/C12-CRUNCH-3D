...
| [resources.md](./01-resources.md) | OnShape docs, mechanism-design references, GD&T and export references, review templates |
| [lecture-notes/01-designing-a-working-mechanism.md](./02-lecture-notes/01-designing-a-working-mechanism.md) | From concept sketch to a kinematic skeleton to an articulating, parametrically robust assembly |
| [lecture-notes/02-shipping-a-cad-deliverable.md](./02-lecture-notes/02-shipping-a-cad-deliverable.md) | Versions and releases, the drawing package, STEP vs STL, and running the design review |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of the three exercises |
| [exercises/exercise-01-concept-to-skeleton.md](./03-exercises/exercise-01-concept-to-skeleton.md) | Turn a concept sketch into a fully-defined kinematic skeleton sketch and a DOF budget |
| [exercises/exercise-02-mate-the-mechanism.md](./03-exercises/exercise-02-mate-the-mechanism.md) | Insert and mate the parts so the mechanism has exactly the intended degrees of freedom |
| [exercises/exercise-03-configure-and-release.md](./03-exercises/exercise-03-configure-and-release.md) | Configure a part, prove the rebuild, tag a Version, and export STEP/STL |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of the weekly challenge |
| [challenges/challenge-01-deliver-the-capstone-live.md](./04-challenges/challenge-01-deliver-the-capstone-live.md) | Deliver the mechanism live: full range of motion, parametric rebuild, design review |
| [quiz.md](./05-quiz.md) | 12 questions, answer key at the bottom |
| [homework.md](./06-homework.md) | The week's deliverables with a rubric |
| [mini-project/README.md](./07-mini-project/00-overview.md) | The full capstone mechanism brief |
