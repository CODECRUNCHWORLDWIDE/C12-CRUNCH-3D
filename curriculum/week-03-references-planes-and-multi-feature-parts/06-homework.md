...
When you've finished all six, create a final **Version** named `Week 3 homework complete`, share the Document, and post the link in your cohort tracker. Then open the [mini-project](./07-mini-project/00-overview.md) and promote your running part.
